...
const routerorderreject = require('./route/orderreject.js');
const routerorderaccept = require('./route/orderaccept.js');
...
app.use('/process/whole', express.static('./pages/wholeprocess.html') );
...
app.use(routerorderreject);
app.use(routerorderaccept);
